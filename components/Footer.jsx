  ...
  return (
    <footer>
      <section className="bg-gray-100 opacity-50 pt-1 mt-10">
        <div className="max-w-screen-xl px-4 py-6 mx-auto space-y-5 overflow-hidden sm:px-6 lg:px-8">
          ...
          <p className="text-xs leading-6 text-center text-gray-600">
            © 2021 ZakSoft, Inc. All rights reserved.
          </p>
        </div>
      </section>
    </footer>
